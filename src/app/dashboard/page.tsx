...
export default function UserProfile() {
  ...
  async function getUser() {
    ...
    setFullName(identityFullName || metadataFullName || '')
  ...
  return (
    <LampContainer>
      ...
      >
        ...
        >
          {userData?.user.email || 'user@email.com'}
        </motion.p>
        ...
        <div className="mt-6 flex justify-center space-x-6">
          {identities.map((identity) => (
            <motion.button
              ...
              className={`flex items-center space-x-2 rounded-full border px-4 py-2 shadow-sm ${
